...
FILES=["2022_58.xlsx","2022_912.xlsx","2023_14.xlsx","2023_58.xlsx","2023_912.xlsx"]
...
for fn in FILES:
    for col,name in COLS.items():
        sv=res[fn][col]
        pv=c.execute(f'SELECT sum(coalesce("{name}",0)) FROM \'out/v3_full.parquet\' WHERE source_file=?',[fn]).fetchone()[0] or 0.0
