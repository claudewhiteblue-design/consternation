...
fx=pd.read_csv('/home/user/consternation/analysis/category_fx_exposure_v2.csv')[['ctg','fx_v2','imp_share']]
d=load('cat').merge(fx,left_on='u',right_on='ctg',how='inner')
print(f'{d.u.nunique()} קטגוריות עם מדד חשיפה')
